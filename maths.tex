...
\begin{frame}{Basic Terminologies}
    \begin{itemize}
        \item \textbf{Point}: A location in space without any dimensions.
        \item \textbf{Line}: A straight figure extending infinitely in both directions.
        \item \textbf{Line Segment}: A part of a line with two endpoints.
        \item \textbf{Ray}: A part of a line that starts at one point and extends infinitely.
        \item \textbf{Plane}: A flat surface that extends infinitely in all directions.
    \end{itemize}
\end{frame}
