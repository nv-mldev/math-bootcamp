...
% \begin{frame}{Summary Table: Ratio vs Rate}
%     \centering
%     \begin{tabular}{|c|c|c|}
%         \hline
%         \textbf{Aspect}         & \textbf{Ratio}                           & \textbf{Rate}                          \\
%         \hline
%         \textbf{Definition}     & Comparison of two similar units          & Comparison of two different units      \\
%         \textbf{Units}          & Unitless                                 & Includes units                         \\
%         \textbf{Form}           & \( a:b \) or \( \frac{a}{b} \)           & \( \frac{\text{miles}}{\text{hour}} \) \\
%         \textbf{Example}        & \( \frac{\text{apples}}{\text{oranges}} \) & \( \frac{\text{miles}}{\text{hour}} \)  \\
%         \textbf{Usage}          & Static relationships                     & Dynamic relationships                  \\
%         \hline
%     \end{tabular}
% \end{frame}
\begin{frame}
...
<<<<<<< HEAD:chapters/geometry/maths.tex
\end{frame}
